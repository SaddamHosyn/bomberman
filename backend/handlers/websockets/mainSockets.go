...
import (
	...
	"bomber-man/backend/handlers/utils"
	"bomber-man/backend/models"
...
// WebSocketManager wraps the hub and provides methods
...
func (wm *WebSocketManager) Run() {
	for {
		select {
		case client := <-wm.Hub.Register:
			wm.registerClient(client)

		case client := <-wm.Hub.Unregister:
...
func WebSocketHandler(w http.ResponseWriter, r *http.Request) {
	...
	globalManager.Hub.Register <- client
