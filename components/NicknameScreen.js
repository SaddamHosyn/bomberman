...
export function NicknameScreen(state, onJoinGame) {
    ...
    return createElement('div', { className: 'nickname-screen fade-in' }, 
        // Game title
        createElement('h1', { className: 'game-title' }, 'BOMBERMAN'),
        createElement('p', { className: 'game-subtitle' }, 'Multiplayer DOM Edition'),
        ...
        // Connection status
        !state.isConnected && !state.isJoining && createElement('div', {
